...
public class AllWords extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        wordsAdapter = new WordsAdapter(this,dbMethods.getAllWords());
        ...
        wordListView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
            ...
            public void onItemClick(AdapterView<?> parent, View view, int position, long id) {
                Cursor cursor = dbMethods.getWordById(id);
                if(cursor.moveToFirst()){
                    textToSpeech.speak(cursor.getString(cursor.getColumnIndex(CSVContract.CSVTable.COL_MEANING)),TextToSpeech.QUEUE_FLUSH,null);
                    cursor.close();
                }
            }
        });
    ...
    private void initUI(){
        wordListView = (ListView)findViewById(R.id.all_words_list);
    }
